...
class RGBChannelBinarizer:
    ...
    def convert_to_grayscale(self, image: Union[Image.Image, np.ndarray], method: str = "luminance") -> np.ndarray:
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_processing_time": (self._stats["total_processing_time"] / self._stats["total_processed"]),
            "min_processing_time": min(self._stats["processing_times"]),
            "max_processing_time": max(self._stats["processing_times"]),
        }

    def assess_quality(self, original: Union[Image.Image, np.ndarray], binary: np.ndarray) -> Dict[str, float]:
