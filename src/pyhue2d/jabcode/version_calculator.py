...
class SymbolVersionCalculator:
    ...
    def calculate_version(self, data_size: int, color_count: int, ecc_level: str) -> int:
    ...
    def _create_capacity_tables(self) -> Dict[int, Dict[int, int]]:
        ...
        for version in range(1, MAX_SYMBOL_VERSIONS + 1):
            ...
            usable_modules = total_modules - finder_pattern_modules - alignment_pattern_overhead - metadata_overhead
