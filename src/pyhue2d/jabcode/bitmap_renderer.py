...
class BitmapRenderer:
    ...
    def render_matrix(self, color_matrix: np.ndarray) -> Bitmap:
        ...
        try:
            ...
            # Create bitmap
            bitmap = Bitmap(array=rgb_array, width=rgb_array.shape[1], height=rgb_array.shape[0])
    ...
    def _add_quiet_zone(self, matrix: np.ndarray) -> np.ndarray:
        ...
        padded_matrix[quiet_zone_pixels:-quiet_zone_pixels, quiet_zone_pixels:-quiet_zone_pixels] = matrix
    ...
    def _validate_settings(self) -> None:
        ...
        if not isinstance(bg_color, (tuple, list)) or len(bg_color) != 3 or not all(0 <= c <= 255 for c in bg_color):
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_render_time": (self._stats["total_render_time"] / self._stats["total_renders"]),
