...
class ImageExporter:
    ...
    def export_bitmap(self, bitmap: Bitmap, filepath: Union[str, Path], 
    ...
    def export_image(self, image: Image.Image, filepath: Union[str, Path], 
                    format: Optional[str] = None, **kwargs) -> None:
    ...
    def export_matrix(self, matrix: np.ndarray, filepath: Union[str, Path], 
                     format: Optional[str] = None, **kwargs) -> None:
    ...
    def export_batch(self, bitmaps: List[Bitmap], filepaths: List[Union[str, Path]], 
                    format: Optional[str] = None, **kwargs) -> None:
    ...
    def export_bitmap_with_metadata(self, bitmap: Bitmap, filepath: Union[str, Path], 
    ...
    def _get_format_settings(self, format: str, **kwargs) -> Dict[str, Any]:
        ...
        for key, value in kwargs.items():
            if key not in ['optimize', 'quality', 'compression_level', 'progressive', 'dpi']:
                settings[key] = value
    ...
    def get_export_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_export_time': (
                self._stats['total_export_time'] / self._stats['total_exports']
            ),
