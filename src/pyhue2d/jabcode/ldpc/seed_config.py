...
class RandomSeedConfig:
    ...
    def __init__(self, metadata_seed: int = LDPC_METADATA_SEED, message_seed: int = LDPC_MESSAGE_SEED):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        """
        return {
            'metadata_seed': self.metadata_seed,
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.metadata_seed == other.metadata_seed and 
                self.message_seed == other.message_seed)
    ...
    def __repr__(self) -> str:
        ...
        return (f"RandomSeedConfig(metadata_seed={self.metadata_seed}, "
    ...
    def is_default_configuration(self) -> bool:
        ...
        """
        return (self.metadata_seed == LDPC_METADATA_SEED and 
                self.message_seed == LDPC_MESSAGE_SEED)