...
import pytest
import numpy as np
from src.pyhue2d.jabcode.ldpc.codec import LDPCCodec
    ...
    def test_codec_different_ecc_levels(self):
        ...
        for ecc_level in ["L", "M", "Q", "H"]:
            try:
                ...
                # Higher ECC levels should produce longer encoded data
                if ecc_level == "H":
                    # Store for comparison with lower ECC levels
                    high_ecc_length = len(encoded)
